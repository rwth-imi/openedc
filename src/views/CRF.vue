...
<div>
  <b-row>
    ...
    <b-col sm="10" class="mainPage">
      <PatientDisplay :patientNumber="patientNumber" :date="date" :dates="dates"></PatientDisplay>


      <h1>CRF: {{ crf.name }}</h1>
      <div v-for="subsection in crf.sections[section].subsection" :key="subsection.name">
