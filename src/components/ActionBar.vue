<template>
  <b-row class="actionBar">
    <b-col sm="3">
      <div v-if="multipleRecords"><label :for="'recordSelect'">Record:</label></div>
    </b-col>
    <b-col sm="3">
      <div v-if="multipleRecords"><b-form-select
          id="recordSelect"
          v-model="localRecord"
          :options="records"
          class="mb-3"
...
export default {
  name: "ActionBar",
  props: ["multipleRecords", "record", "records", "crfId"],
  data() {
    return {
      localRecord: null
    }
